#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# Practical 3 - Lakebase  •  Unity Catalog SYNCED TABLE (reverse ETL)
# ---------------------------------------------------------------------------
...
#    spec.postgres_database. Works as a non-metastore admin: the table syncs and
#    is queryable from Postgres.
#
